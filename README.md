...
![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/nifi/nifi_group.PNG)

`Groupe 1` : nous avons créer ce groupe pour convertir les fichiers excel en csv :

![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/nifi/nifi_flow1.PNG)
...
![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/nifi/nifi_flow2.PNG)

![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/nifi/resultat_hdfs.PNG)
...
![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/nifi/nifi_registry_flow.PNG)
...
![enter image description here](https://github.com/MonDataa/data_pipeline-projet-Nifi-spark-airflow/blob/master/airflow/airflow_dag.PNG)
